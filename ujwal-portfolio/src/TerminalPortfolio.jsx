...
💭 "If you like terminals, APIs, AI or security,
  ...
  const getPrompt = () => `ujwal@portfolio:${currentPath}$`;
    ...
    >
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="relative rounded-xl border border-green-500/30 bg-black/80 shadow-[0_0_30px_rgba(34,197,94,0.45)] overflow-hidden">
          ...
          <div
            ref={terminalRef}
            className="max-h-[70vh] min-h-[50vh] overflow-y-auto overflow-x-auto px-3 sm:px-4 py-3 text-[12px] sm:text-[13px] leading-relaxed"
          >
            {history.map((entry, index) => (
              <div key={index} className="mb-1">
                {entry.type === 'input' ? (
